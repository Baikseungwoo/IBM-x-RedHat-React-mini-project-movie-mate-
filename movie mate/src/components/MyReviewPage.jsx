...
const MyReviewsPage = () => {
  ...
  const pagedReviews = myReviews.slice(startIndex, startIndex + ITEMS_PER_PAGE);
          ...
          <div className="space-y-4">
            {pagedReviews.map((r) => (
              <div
                ...
                className="group cursor-pointer rounded-2xl border border-gray-200 bg-white px-5 py-4 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-amber-50/60 hover:shadow-md"
              >
                <div className="flex items-start justify-between gap-4">
                  
                  {/* 왼쪽 */}
                  <div className="flex-1">
                    <h4 className="text-lg font-semibold text-stone-800 group-hover:text-amber-700">
                      {r.title}
                    </h4>
